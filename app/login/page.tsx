  ...
  return (
    <div className="flex min-h-screen min-h-[100dvh] w-full flex-col">
      ...
      <div className="relative flex min-h-0 w-full flex-1 flex-col">
        ...
        <div className="absolute inset-0 z-10 flex items-center justify-center px-4 py-8 sm:px-6 sm:py-10">
          <div className="ui-card relative w-full max-w-md p-6 sm:p-7">
